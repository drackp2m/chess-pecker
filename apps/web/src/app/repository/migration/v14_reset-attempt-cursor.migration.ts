...
/**
 * Already-restored attempts came in without their place in the round or the cycle, which did
 * not travel then. Forgetting the cut brings them back once, which is when the row learns it.
 */
